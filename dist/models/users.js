...
var pepper = process.env.BYCRPT_PASSWORD;
...
var UserStore = /** @class */ (function () {
    ...
    UserStore.prototype.create = function (u) {
        return __awaiter(this, void 0, void 0, function () {
            var conn, sql, hash, result, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 3:
                        err_2 = _a.sent();
                        throw new Error("Could not create new user: ".concat(err_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("Could not get user with id ".concat(id, ": ").concat(err_4));
                    case 4: return [2 /*return*/];
                }
            });
        });
